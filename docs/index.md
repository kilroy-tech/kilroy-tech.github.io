...
plumbing and runtime support to connect local AI agents with messaging services, cloud platforms, and remote Kilroy users. 

Based around the concept of
peer-to-peer swarms, Kilroy makes building and sharing your own version of the Internet possible. Collaborate with friends over private, end-to-end encrypted communications.
...
## Other Resources
 * [Kilroy.Tech website](https://kilroy.tech/){ target="_blank" }
 * [Kilroy.Tech Github](https://github.com/kilroy-tech/){ target="_blank" }
 * [Kilroy Wiki](https://github.com/kilroy-tech/kilroy/wiki/Kilroy-Wiki){ target="_blank" }
